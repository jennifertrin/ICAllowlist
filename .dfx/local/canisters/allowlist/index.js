...
import { idlFactory } from './allowlist.did.js';
export { idlFactory } from './allowlist.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ALLOWLIST_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./allowlist.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the allowlist canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./allowlist.did.js")._SERVICE>}
 */
export const allowlist = createActor(canisterId);
